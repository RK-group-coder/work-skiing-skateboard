...
// Remove the garbage appended earlier
const garbageIndex = content.lastIndexOf("`\n<!-- Quest 5 Step 4 Page (Other Hospitals) -->\n<div class=\"page\" id=\"page-task-quest5-step4\" style=\"display: none");
if (garbageIndex !== -1) {
    content = content.substring(0, garbageIndex);
}

// Ensure the onclick attribute is injected on the right card
  ...
  <div style="display: flex; max-width: 1400px; margin: 40px auto; gap: 32px; padding: 0 20px; align-items: stretch;">
    ...
    <aside style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); padding: 32px; width: 340px; display: flex; flex-direction: column; flex-shrink: 0;">
      ...
      <div id="q5s4-steps" style="display: flex; flex-direction: column; gap: 0;">
        ...
        <div class="q5s4-step">
          <div class="q5s4-step-left"><div class="q5s4-step-check"></div></div>
...
console.log("Successfully appended step 4 to the end of the file.");
